...
<body>
    ...
    <nav>
        ...
        <ul>
        		<c:url value="weightInput" var="weightInput"/>
        		<c:url value="ageInput" var="ageInput"/>
        		<c:url value="travelInput" var="travelInput"/>
        		<c:url value="forum" var="forum"/>
            <li><a href="${ageInput}">Alien Age</a></li>
            <li><a href="${weightInput}">Alien Weight</a></li>
            <li><a href="${travelInput}">Drive Time</a></li> 
