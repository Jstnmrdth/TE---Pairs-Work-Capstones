...
-- Could not delete because Smallville is a FK in country and capital of USA was not returned to old value.
...
-- Smallville is no longer the capital and it's no longer a forgien key in country.
